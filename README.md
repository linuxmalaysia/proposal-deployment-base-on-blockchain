...
## 🌟 Key Features
- **Key Management:** Open-source MPC (Multi-Party Computation) threshold quorums via planned Coinbase `cb-mpc` integration and HSM-backed Hot/Warm/Cold vault tiering (see [Open-Source MPC Wallet Architecture](docs/explanation/open-source-mpc-wallet-architecture.md)).

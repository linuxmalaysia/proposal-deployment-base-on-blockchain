...
1. What research assets currently exist across various faculties and centres of excellence.
2. Who holds clear, legal inventorship and ownership rights over specific research artifacts.
...
+-----------------------------------------------------------------------+
|  Academic Laboratory Discovery (TRL 1-3)                              |
|  - Isolated spreadsheets, paper files, unverified claims              |
+-----------------------------------------------------------------------+
                                  |
                                  v
+-----------------------------------------------------------------------+
...
+-----------------------------------------------------------------------+
                                  ...
                                  v
+-----------------------------------------------------------------------+
|  Market Deployment & Enterprise Commercialisation (TRL 7-9)          |
+-----------------------------------------------------------------------+
```
...
- Proceed to Section 2: [Business Case: Research as an Asset Class](rcf-dac-business-case.md)

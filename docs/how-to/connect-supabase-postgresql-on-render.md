...
3. **Database Migration Pipeline:** Perform database migrations (`supabase db push` or `npx prisma migrate deploy`) during pre-deploy steps or dedicated CI/CD execution tasks to maintain dual-write transaction consistency.

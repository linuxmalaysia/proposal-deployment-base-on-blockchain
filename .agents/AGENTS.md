...
## 📜 27 Operational Laws & Directives
...
- All documentation, code comments, and commit messages MUST strictly use UK English (e.g., `initialise`, `prioritise`, `segregated`) or DBP-standard Bahasa Melayu Malaysia (Piawai). Avoid US spelling variants.
